...
<div class="block-header block-header-default">
    <h3 class="block-title">Kode Dosen Penguji</h3>
</div>
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-edited">
        <thead>
            <tr>
                ...
                <th class="d-none d-sm-table-cell text-center" style="width: 20%">Kode Dosen Penguji</th>
                <th class="text-center" style="width: 20%;">Nip Dosen</th>
                <th class="text-center" style="width: 57%;">Nama Dosen</th>
                <!-- <th class="text-center" style="width: 25%;">Penguji Pendadaran</th> -->
            </tr>
        </thead>
        <tbody>
            <?php $no=1?>
            ...
            <tr>
                ...
                <td class="d-none d-sm-table-cell text-center font-size-sm text-center"><a href="#">{{ $row->id}}</a></td>
...
<!-- END Dynamic Table Full -->
    ...
    <div class="block">
        ...
        <!-- Judul Halaman -->
        <div class="block-header block-header-default">
            <h3 class="block-title">List Penguji</h3>
        </div>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-edited">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="width: 20%;">Penguji Ke</th>
                        <th class="text-center" style="width: 25%;">Penguji Semhas</th>
                        <th class="text-center" style="width: 25%;">Penguji Pendadaran</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-w600 font-size-sm text-center">
                            <a href="#">{{ $row->penguji_semhas}}</a>
                        </td>
                        <td class="font-w600 font-size-sm text-center">
                            <a href="#">{{ $row->penguji_pendadaran}}</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
